var data = [
  {
    ...
    大兴安岭地区: ['松岭区', '新林区', '呼中区', '呼玛县', '塔河县', '漠河县', '加格达奇区'],
    上海市: [
      '黄浦区',
      '徐汇区',
      '长宁区',
    ...
    苏州市: ['虎丘区', '吴中区', '相城区', '姑苏区', '常熟市', '张家港市', '昆山市', '吴江区', '太仓市'],
    ...
    合肥市: ['瑶海区', '庐阳区', '蜀山区', '包河区', '长丰县', '肥东县', '肥西县', '巢湖市', '庐江县'],
    ...
    长沙市: ['芙蓉区', '天心区', '岳麓区', '开福区', '雨花区', '长沙县', '望城区', '宁乡县', '浏阳市'],
    ...
    阳江市: ['江城区', '阳西县', '阳东县', '阳春市'],
    清远市: ['清城区', '佛冈县', '阳山县', '连山壮族瑶族自治县', '连南瑶族自治县', '清新区', '英德市', '连州市'],
    东莞市: [
      '东城街道',
      '南城街道',
      '万江街道',
    ...
    五指山市: ['通什镇', '南圣镇', '毛阳镇', '番阳镇', '畅好乡', '毛道乡', '水满乡', '国营畅好农场'],
    琼海市: [
      '嘉积镇',
      '万泉镇',
      '石壁镇',
    ...
    宜宾市: ['翠屏区', '宜宾县', '南溪区', '江安县', '长宁县', '高县', '珙县', '筠连县', '兴文县', '屏山县'],
    ...
    贵阳市: ['南明区', '云岩区', '花溪区', '乌当区', '白云区', '开阳县', '息烽县', '修文县', '观山湖区', '清镇市'],
    ...
    海东市: ['平安县', '民和回族土族自治县', '乐都区', '互助土族自治县', '化隆回族自治县', '循化撒拉族自治县'],
    ...
    石河子市: ['新城街道', '向阳街道', '红山街道', '老街街道', '东城街道', '北泉镇', '石河子乡', '兵团一五二团'],
    阿拉尔市: [
      '金银川路街道',
      '幸福路街道',
      '青松路街道',
