<template>
  <div class="vip-content">
    <div class="vip-head-tool">
      ...
      <el-button
        v-if="jurisdiction['marketingOperations:smsManager:save']"
        type="primary"
        class="fr"
        @click="toDetail()"
        >新建模板</el-button
    ...
    <div v-loading="msgListLoading">
      <el-table :data="msgListData.entities" style="width: 100%">
        ...
        <el-table-column label="模板名称" min-width="21%" show-overflow-tooltip>
          <template scope="scope">
        ...
        <el-table-column prop="templateContent" label="内容" min-width="50%" show-overflow-tooltip> </el-table-column>
        ...
        <el-table-column label="操作" width="160">
          <template scope="scope">
            <a
              v-if="jurisdiction['marketingOperations:smsManager:edit']"
              href="javascript:;"
            ...
            >
            <a
              v-if="jurisdiction['marketingOperations:smsManager:delete']"
              href="javascript:;"
              class="operation-btn"
...
export default {
  ...
  methods: {
    ...
    toDetail(id, type) {
      this.$router.push({
        path: '/communication/msgtemplate',
        query: {
          id,
          type,
    ...
    listSearch() {
      ...
      this.requestComm.smsSearch(data).then((data) => {
