        ...
        <div class="config-item">
          <div class="config-item-1-2">
            <div>
              ...
              <label for=""
                ><span>活动有效期：</span>
                <p>{{ repeatForm.startTime | timeFilter }} - {{ repeatForm.endTime | timeFilter | endTimeFilter }}</p>
              </label>
              <label for=""
                ><span>礼品兑换有效期：</span>
                <p>
            ...
            <div class="config-item-1-2 config-gift edit-config-1-2" style="margin-bottom:0">
              <div style="height:auto;margin: -1px -1px -1px 0;">
                <div v-if="form.scoreGiftConfig">
                  <span v-if="form.giftType === 5">
                    <div class="rightsConfirm-givenCard-example dis-flex-imp">
                      <img class="portrait" :src="form.scoreGiftConfig.rightList[0].virtualGiftList[0].picUrl" />
                      <div class="cnt">
                        <p>{{ form.scoreGiftConfig.rightList[0].virtualGiftList[0].cardName }}</p>
                        <p class="mt20">兑换数量（{{ form.scoreGiftConfig.rightList[0].virtualGiftList[0].num }}）</p>
                  ...
                  <span v-else>
                    ...
                    <div v-if="form.scoreGiftConfig.twoTypes" style="display:block;">
                      <div style="margin-bottom:10px;">
                        <img src="../../assets/images/score.jpg" alt="" />
                        <p>购买 2 件产品赠送</p>
                        <p class="gift">
                    ...
                    <div v-if="form.scoreGiftConfig.threeTypes" style="display:block;">
                      <div style="margin-bottom:10px;">
                        <img src="../../assets/images/score.jpg" alt="" />
                        <p>购买 3 件产品赠送</p>
                        <p class="gift">
                          {{ form.scoreGiftConfig.threeTypes.score }}积分（总数{{
                            form.scoreGiftConfig.threeTypes.num
                          }}份）
                        </p>
                      </div>
                    </div>
                    <div v-if="form.scoreGiftConfig.fourTypes" style="display:block;">
                      <div style="margin-bottom:10px;">
                        <img src="../../assets/images/score.jpg" alt="" />
                        <p>购买 4 件产品赠送</p>
                        <p class="gift">
                          {{ form.scoreGiftConfig.fourTypes.score }}积分（总数{{
                            form.scoreGiftConfig.fourTypes.num
                          }}份）
                        </p>
                      </div>
                    </div>
                    <div v-if="form.scoreGiftConfig.fiveTypes" style="display:block">
                      <div style="margin-bottom:10px;">
                        <img src="../../assets/images/score.jpg" alt="" />
                        <p>购买 5 件及以上产品赠送</p>
                        <p class="gift">
                          {{ form.scoreGiftConfig.fiveTypes.score }}积分（总数{{
                            form.scoreGiftConfig.fiveTypes.num
                          }}份）
                        </p>
                      </div>
                    </div>
