    ...
    <div style="width: 898px; margin: auto;">
      <div class="config-form">
        ...
        <el-form ref="form" :model="form" :rules="rules">
          <el-form-item label="活动小微" label-width="180px" prop="" class="required">
          ...
          <el-form-item label="活动渠道" label-width="180px" prop="" class="required">
            <div>
          ...
          <el-form-item label="活动门店" label-width="180px" prop="" class="required">
            <el-input
          ...
          <el-form-item label="选择不同享活动类型" label-width="180px" prop="" class="required" v-if="isMutex">
          ...
          <el-form-item label="同享活动" label-width="180px" prop="" class="required" v-if="isMutex && mutexType == 3">
            <el-input
          ...
          <el-form-item label="选择同享活动" label-width="180px" v-show="!isMutex && form.giftType === 5">
            <el-checkbox-group v-model="form.actShareType">
              <el-checkbox :label="1">与任意活动同享 </el-checkbox>
            </el-checkbox-group>
          </el-form-item>
          <el-form-item>
    ...
    getOrderRightsById() {
      ...
      this.requestRights.getOrderRightsById(params).then((data) => {
        if (data) {
          ...
          _this.mutexType == null ? 1 : data.exclusiveType;
          ...
          setTimeout(() => {
            ...
            if (_this.form.channelName.length == arr.a) {
      ...
      axios
        ...
        .then((data) => {
          if (data) {
            ...
            _this.$router.push({ path: '/rights/rightsGifttwo', query: { id: _this.form.id } });
          }
        });
    },
    prev() {
