  ...
  <div>
    ...
    >
      ...
      <el-row class="userdetails-elrow">
        <el-col :span="8"
          ><span>申诉人登录名：</span><span>{{ data.userName }}</span></el-col
        >
        <el-col :span="8"
      ...
      <el-row class="userdetails-elrow">
        ...
        >
        <el-col :span="8"
          ><span>申诉类别：</span><span>{{ data.appealTypeText }}</span></el-col
        >
        <el-col :span="8"
      ...
      <el-row class="userdetails-elrow">
        ...
        >
        <el-col :span="8"
          ><span>产品机编：</span><span>{{ data.skuCode }}</span></el-col
        >
      </el-row>
      <el-row class="userdetails-elrow">
        <el-col :span="8"
      ...
      <el-row class="userdetails-elrow">
        <!--<el-col :span="8"><span>是否虚假：</span><span>{{data.falsity_analysis}}</span></el-col>-->
        <el-col :span="8"
