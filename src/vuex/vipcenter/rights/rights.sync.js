...
import qs from 'qs';
import { axPost, axPostJson } from '@/utils/ajax';
...
const request = {
  ...
  saveNextOrderRights(data) {
    return axPostJson('vipcenter/orderRights/saveNextOrderRights', data);
  },
  // 保存权益信息--中国大区-小微
  ...
  getOrderRightsById(data) {
    return axPost('vipcenter/orderRights/getOrderRightsById', data);
  },
  // 根据id获取订单权益信息--中国大区
  getRightsById(data) {
    return gUtils
  ...
  listProductInfo(data) {
    /* return gUtils.trsGetData().post(Vue.prototype.apiUrl + 'vipcenter/orderRights/listProductInfo', qs.stringify(data))
      .then(function (data) {
        if (data.data.isSuccess) {
          return data.data.data;
        } else {
    ...
    return axPost('vipcenter/orderRights/listProductInfo', data);
  },
  ...
  getCostAmountByGiftConfig(data) {
    return axPost('vipcenter/orderRights/getCostAmountByGiftConfig', data);
  },
  getHonorEnjoyCards(data) {
    /* 获取尊享卡列表 */
    return axPost('vipcenter/virtualGift/queryHonorCard', {}, data);
  },
  // 获取权益成本信息--中国大区
  getCostAmountByChinaGiftConfig(data) {
    return gUtils
      .trsGetData()
      .post(`${Vue.prototype.apiUrl}vipcenter/ChinaRegionRightsController/getCostAmountByGiftConfig`, qs.stringify(data))
      .then((data) => {
        if (data.data.isSuccess) {
          return data.data.data;
        }
  ...
  getStatisticsInfo(data) {
    return gUtils
      .trsGetData()
      .post(`${Vue.prototype.apiUrl}vipcenter/orderRights/getStatisticsInfoByRightIdForSingleProduct`, qs.stringify(data))
      .then(data => data.data)
      .catch((err) => {
        console.warn(err);
        return catchMessage(err);
  ...
  exportStatisticsInfo(data) {
    return gUtils
      .trsGetData()
      .post(`${Vue.prototype.apiUrl}vipcenter/orderRights/exportStatisticsInfoByRightIdForSingleProduct`, qs.stringify(data))
      .then((data) => {
        if (!data.data.isSuccess) {
          returnMsg(data.data.msg);
        }
  ...
  exportChinaDetails(data) {
    return gUtils
      .trsGetData()
      .post(`${Vue.prototype.apiUrl}vipcenter/ChinaRegionRightsController/exportChinaRegionRightsByChinaRightId`, qs.stringify(data))
      .then((data) => {
        if (!data.data.isSuccess) {
          returnMsg(data.data.msg);
        }
  ...
  getStatisticsInfoForCoupleProduct(data) {
    return gUtils
      .trsGetData()
      .post(`${Vue.prototype.apiUrl}vipcenter/orderRights/getStatisticsInfoByRightIdForCoupleProductBuyNum`, qs.stringify(data))
      .then(data => data.data)
      .catch((err) => {
        console.warn(err);
        return catchMessage(err);
  ...
  exportStatisticsInfoForCoupleProduct(data) {
    return gUtils
      .trsGetData()
      .post(`${Vue.prototype.apiUrl}vipcenter/orderRights/exportStatisticsInfoByRightIdForCoupleProductBuyNum`, qs.stringify(data))
      .then((data) => {
        if (!data.data.isSuccess) {
          returnMsg(data.data.msg);
        }
